...
function test_jet(ba::AbstractADType, scen::SecondDerivativeScenario{1}; ref_backend)
    (; f, x, y) = deepcopy(scen)
...
function test_jet(ba::AbstractADType, scen::HVPScenario{1}; ref_backend)
...
function test_jet(ba::AbstractADType, scen::HessianScenario{1}; ref_backend)
    (; f, x, y) = deepcopy(scen)
