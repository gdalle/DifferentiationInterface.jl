...
function test_correctness(
    ba::AbstractADType, scen::PushforwardScenario{false}; isapprox::Function, atol, rtol
)
...
function test_correctness(
    ba::AbstractADType, scen::PushforwardScenario{true}; isapprox::Function, atol, rtol
)
    (; f, x, y, dx, dy, ref) = new_scen = deepcopy(scen)
    f! = f
...
function test_correctness(
    ba::AbstractADType, scen::PullbackScenario{false}; isapprox::Function, atol, rtol
)
    (; f, x, y, dx, dy, ref) = new_scen = deepcopy(scen)
...
function test_correctness(
    ba::AbstractADType, scen::PullbackScenario{true}; isapprox::Function, atol, rtol
)
    (; f, x, y, dx, dy, ref) = new_scen = deepcopy(scen)
    f! = f
...
function test_correctness(
    ba::AbstractADType, scen::DerivativeScenario{false}; isapprox::Function, atol, rtol
)
    (; f, x, y, dx, dy, ref) = new_scen = deepcopy(scen)
...
function test_correctness(
    ba::AbstractADType, scen::DerivativeScenario{true}; isapprox::Function, atol, rtol
)
    (; f, x, y, dx, dy, ref) = new_scen = deepcopy(scen)
    f! = f
...
function test_correctness(
    ba::AbstractADType, scen::GradientScenario{false}; isapprox::Function, atol, rtol
)
    (; f, x, y, dx, dy, ref) = new_scen = deepcopy(scen)
...
function test_correctness(
    ba::AbstractADType, scen::JacobianScenario{false}; isapprox::Function, atol, rtol
)
...
function test_correctness(
    ba::AbstractADType, scen::JacobianScenario{true}; isapprox::Function, atol, rtol
)
...
function test_correctness(
    ba::AbstractADType, scen::SecondDerivativeScenario; isapprox::Function, atol, rtol
)
...
function test_correctness(
    ba::AbstractADType, scen::HVPScenario; isapprox::Function, atol, rtol
)
...
function test_correctness(
    ba::AbstractADType, scen::HessianScenario; isapprox::Function, atol, rtol
)
    (; f, x, y, ref) = new_scen = deepcopy(scen)
